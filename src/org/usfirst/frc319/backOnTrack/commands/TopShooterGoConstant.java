 ...
 *
 */
public class  TopShooterGoConstant extends Command {

    public TopShooterGoConstant() {
    ...
    protected void execute() {
    	...
    	Robot.shooter.topshooterGoConstant();
    	System.out.println("pulley speed ="+Robot.shooter.topshooterSpeed());
